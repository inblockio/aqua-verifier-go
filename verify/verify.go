...
func getVerificationSet(data *api.HashChain, depth int) ([]*api.Revision, int, error) {
	var height int
...
func verifyOfflineData(data *api.HashChain, doVerifyMerkleProof bool, depth int) bool {
